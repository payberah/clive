...
public class ResponseHelperNodes extends MSMessage {

	private static final long serialVersionUID = -6815596147580962155L;
	private final ArrayList<MSPeerAddress> nodes;

//-------------------------------------------------------------------	
	public ResponseHelperNodes(MSPeerAddress source, MSPeerAddress destination, ArrayList<MSPeerAddress> nodes) {
