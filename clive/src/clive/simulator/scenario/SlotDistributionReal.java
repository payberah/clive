...
public class SlotDistributionReal extends Distribution<BigInteger> {
	/*
	...
	public SlotDistributionReal(Random random) {
...
//-------------------------------------------------------------------
	...
	public static void main(String args[]) {
		...
		SlotDistributionReal md = new SlotDistributionReal(new Random());
