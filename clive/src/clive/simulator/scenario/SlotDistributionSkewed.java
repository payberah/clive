...
public class SlotDistributionSkewed extends Distribution<BigInteger> {
	/*
	...
	public SlotDistributionSkewed(Random random) {
...
//-------------------------------------------------------------------
	public static int getUtilityLevel(int utilityValue) {
		...
		if (utilityValue == 2)
			...
			utilityLevel = 5;
		else if (utilityValue == 12)
			utilityLevel = 6;
		else if (utilityValue == 14)
			utilityLevel = 7;
		else if (utilityValue == 16)
			utilityLevel = 8;
		else if (utilityValue == 18)
			utilityLevel = 9;
		else if (utilityValue == 20)
			utilityLevel = 10;
		else 
			utilityLevel = 11;
...
//		
	...
	public static void main(String args[]) {
		...
		SlotDistributionSkewed md = new SlotDistributionSkewed(new Random());
